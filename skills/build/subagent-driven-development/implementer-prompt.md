---
name: subagent-driven-development-implementer-prompt
description: Use when dispatching an implementer subagent for a task — provides the full template with quality gates and escalation paths.
---
